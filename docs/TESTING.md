...
> **最后更新**：2026-09-25（`M11-7`：`TC-040` 计数 25→27（栈规则 +2：clear 双向清空 `FR-1737` 原语、旁路编辑快照回退语义披露）；此前同日：`M11-6` 新增 `TC-041`、`TC-040` 计数 23→25；`T-004` 固化 TC-022/024/028 矩阵；此前 2026-09-24：`M11-0` 新增 `TC-040` 撤销基线）
