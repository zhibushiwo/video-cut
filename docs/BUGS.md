...
> **来源**：[archive/code-review-2026-09-19.md](./archive/code-review-2026-09-19.md)（评审报告，只追加）· 真机 GUI 自动化首跑（[gui-e2e/README.md](./gui-e2e/README.md)，`BUG-007`–`BUG-009`）· `R4-4` 实施时的同族复查（`BUG-010`，2026-09-23）· `R3-7` 实施时的同类复查（`BUG-011`，2026-09-24）· `M11-5` 两轴 CR 的规格冲突复查（`BUG-012`，2026-09-25）
...
> **最后更新**：2026-09-25（`M11-6` 落地 `BUG-012` 裁决 → `fixed`：命令层切割/修剪下限抬到 `max(1帧, 0.05s)` 与导出映射阈值对齐，回归 `TC-041`；此前同日：`M11-5` CR 登记 `BUG-012`（open）；此前 2026-09-24：`R3-7` 落地 `BUG-011` → `fixed`，回归 `TC-039`）
