...
> **最后更新**：2026-09-23（`R4-5` 落地：`BUG-005` → `fixed`（`TC-023` 的命令级半已过、UI 半待跑）；同日 `R4-4`/`R4-9`：`BUG-004`/`BUG-010` → `fixed`；此前 2026-09-21：`R4-1`/`R4-2` → `verified`、`R4-3` → `fixed`、`BUG-007`/`BUG-009` → `verified`）
