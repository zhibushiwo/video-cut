...
> **最后更新**：2026-09-25（`M11-5` CR 登记 `BUG-012`（切割短半段绕过导出映射阈值 → 导出整段源；规格内部冲突，open，随 `M11-6` 裁决）；此前 2026-09-24：`R3-7` 落地 `BUG-011` → `fixed`，回归 `TC-039`；此前 2026-09-23：`R4-7` 落地 `BUG-006` → `fixed`——R4 段 9 条至此全部实施完毕）
