...
| **FR-17xx** 单轨时间线（§17.3 坐标与精度已随 `M11-1` 发号：`FR-1730`~`FR-1735`，见 [TIMELINE.md](./TIMELINE.md) §17.3；其余 §17.x 随后续批次发号） | TIMELINE.md §17 | `ClipTimeline`/`CropOverlay` · `ProductPreview`/`TaskProgress`/`hooks` | M11-0 ✅ … M11-3 ✅ · M11-4 … M11-9 · M12 · M13 | TIMELINE.md §17.9 ①~⑥ · **TC-040**（撤销基线，`M11-0`）· 其余 TC 待建 | 🔄 进行中（`M11-0`–`M11-3` 已实施） |
